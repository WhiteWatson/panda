  ...
  return (
    <>
      <Dialog
        ...
        message={signUrl} /><View className="index min-h-[100vh] bg-[#f6f6f6]">
        ...
        <View>
          ...
          >
            <AtTabsPane current={tabCurrent} index={0}>
              <ElectronicContract contractData={contractData} setIsOpened={setIsOpened} setSignUrl={setSignUrl}></ElectronicContract>
            </AtTabsPane>
